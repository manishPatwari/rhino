    ...
    implements Symbol
{
    ...
    public static void init(Context cx, Scriptable scope, boolean sealed) {
        ...
        try {
            createStandardSymbol(cx, scope, ctor, SymbolKey.ITERATOR);
            createStandardSymbol(cx, scope, ctor, SymbolKey.SPECIES);
            createStandardSymbol(cx, scope, ctor, SymbolKey.TO_STRING_TAG);
            createStandardSymbol(cx, scope, ctor, SymbolKey.HAS_INSTANCE);
            createStandardSymbol(cx, scope, ctor, SymbolKey.IS_CONCAT_SPREADABLE);
            createStandardSymbol(cx, scope, ctor, SymbolKey.TO_PRIMITIVE);
            createStandardSymbol(cx, scope, ctor, SymbolKey.MATCH);
            createStandardSymbol(cx, scope, ctor, SymbolKey.REPLACE);
            createStandardSymbol(cx, scope, ctor, SymbolKey.SEARCH);
            createStandardSymbol(cx, scope, ctor, SymbolKey.SPLIT);
            createStandardSymbol(cx, scope, ctor, SymbolKey.UNSCOPABLES);
        } finally {
